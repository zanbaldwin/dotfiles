...
user_pref("browser.newtabpage.activity-stream.default.sites", ""); // remove default Top Sites (Facebook, Twitter, etc.)
...
user_pref("signon.rememberSignons", false); // disable login manager

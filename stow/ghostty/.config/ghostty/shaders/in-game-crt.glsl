...
// [0, 1]
#define SCAN_LINES_STRENGTH 0.3
...
// x \in R : x >= 0
#define APERTURE_GRILLE_STRENGTH 0.1
...
// x \in R : x >= 0
#define FLICKER_STRENGTH 0.10
// How fast the screen flickers
// x \in R : x > 0
#define FLICKER_FREQUENCY 950.0

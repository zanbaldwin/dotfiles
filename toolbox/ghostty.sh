...
tar vxJf "${BUILD_DIR}/zig.tar.xz" -C "${BUILD_DIR}"
tar vxzf "${BUILD_DIR}/ghostty.tar.gz" -C "${BUILD_DIR}"
...
mv "${BUILD_DIR}/ghostty-${GHOSTTY_VERSION}/zig-out/bin/ghostty" "${HOME}/.local/bin/ghostty"
